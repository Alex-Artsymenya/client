...
public class ClientAppointmentsController implements Initializable {
    ...
    public void OnEdit() throws IOException {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/adminFXML/EditAppointment.fxml"));
            Scene newScene = new Scene(root);
            stage.setScene(newScene);
        } catch (IOException e) {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        List<Appointment> appointments = new Gson().fromJson(batchGetService.GetEntities(Requests.GET_ALL_APPOINTMENTS),
                                                             listType);
