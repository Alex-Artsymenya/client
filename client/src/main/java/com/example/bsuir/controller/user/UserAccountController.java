...
public class UserAccountController implements Initializable {
    ...
    public void Employee_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/fxml/user/employee.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void Services_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/fxml/user/services.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void Get_Information_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/fxml/user/client_appointments.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
